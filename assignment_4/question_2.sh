...
# Before beginning, initialise a value for delta

#Delta is the minimum value of error that the Newtons method must return, which is less than, for the loop to break
delta=0.000000001 #After playing around with various values, for ideal computation time I chose delta to be this
a=$1

# Create a Sage script for all definitons and calculation
